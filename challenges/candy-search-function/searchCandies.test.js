...
describe('searchCandies', () => {
  it('returns an array of Mars & Maltesers, when passed "Ma" and "10"', () => {
    subString = 'Ma';
    maxPrice = 10;
    expect(searchCandies(subString, maxPrice)).toEqual([ 'Mars', 'Maltesers' ]);
  })

  it('returns an array of Skitties, Skittles, Starbust when passed "S" and "10"', () => {
    subString = 'S';
    maxPrice = 10;
    expect(searchCandies(subString, maxPrice)).toEqual([ 'Skitties', 'Skittles', 'Starburst' ]);
  })

  it('returns an array of Mars, when passed "Ma" and "2', () => {
    subString = 'Ma';
    maxPrice = 2;
    expect(searchCandies(subString, maxPrice)).toEqual([ 'Mars' ]);
  })
  
  it('returns an array of Skitties, Skittles, when passed "S" and "4"', () => {
    subString = 'S';
    maxPrice = 4;
    expect(searchCandies(subString, maxPrice)).toEqual([ 'Skitties', 'Skittles' ])
  })
})
